...
let zonaA = [   {subca:"AND000", color:"ROJO" },
				...
				{subca:"SCO1", color:"ROJO" },
	     			{subca:"SGU1", color:"ROJO" },
	     			{subca:"SVI1", color:"ROJO" },
...
let zonaB = [   {subca:"AND010", color:"AMARILLO" },
				...
				{subca:"SSF1", color:"AMARILLO" },
	     			{subca:"SSF1_X", color:"AMARILLO" },
	     			{subca:"SPN1", color:"AMARILLO" },
	     			{subca:"SPG1", color:"AMARILLO" },
